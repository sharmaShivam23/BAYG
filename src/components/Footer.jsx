...
const Footer = () => {
  return (
    <footer className="bg-[#2d2d2d] text-white px-6 py-10 mt-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6 border-b border-gray-500 pb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-center gap-2"><FaPhoneAlt className="text-orange-500" /><a href="tel:+91-7906266780"> +91-7906266780</a>,<a href="tel:+91-8588940423">+91-8588940423</a></li>
