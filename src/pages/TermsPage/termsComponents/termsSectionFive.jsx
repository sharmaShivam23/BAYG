  ...
  return (
    <section className="bg-orange-100 pb-0">
      <div className="max-w-4xl w-[90%] mx-auto text-center pt-16 pb-10 space-y-6">
        <h2 className="text-3xl font-semibold text-gray-800">4. User Responsibilities</h2>
        <p className="text-gray-600 text-base md:text-lg leading-relaxed">
          You agree not to misuse the services. Users are expected to act responsibly and refrain from any activity that may damage or disrupt the service.
        </p>
      </div>
