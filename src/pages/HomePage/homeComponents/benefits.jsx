...
const BenefitsSection = () => {
  return (
    <div className="w-full bg-gradient-to-r from-orange-100 to-orange-300 py-16 px-4">
      <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
        {/* Text ke Cards */}
        <div className="flex flex-col gap-6 w-full lg:w-1/2">
          <div className="bg-[#fff3e6] shadow-md p-6 rounded-lg transform rotate-[-5deg]">
          ...
          <div className="bg-[#fff3e6] shadow-md p-6 rounded-lg transform rotate-[3deg]">
