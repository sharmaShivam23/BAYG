...
<div className="w-[80%] mx-auto px-4 py-6">
  <div className="flex flex-col md:flex-row gap-6">
    ...
    <div className="flex-1 bg-gray-300 p-4 rounded">
      ...
      <div className="w-[80%] mx-auto px-4 py-10 text-center md:text-left">
  <p className="text-gray-500 uppercase text-sm font-semibold mb-2">Welcome to our site!</p>
  ...
  <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
    ...
    <div>
      <p className="text-orange-500 text-xl font-bold">100+</p>
